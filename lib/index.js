  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        ' ',
        this.props.displayDate.getFullYear() - (this.props.taiwanFormat ? 1911 : 0)
      ),
      _react2.default.createElement(
        'div',
    ...
    for (var i = 0; i < 9; i++) {
      ...
      for (var j = 0; j <= 6; j++) {
        if (day <= monthLength && (i > 0 || j >= startingDay)) {
          ...
          week.push(_react2.default.createElement('td', { key: '' + j + Math.random() }));
        }
      }
...
exports.default = (0, _createReactClass2.default)({
  ...
  propTypes: {
    taiwanFormat: _propTypes2.default.bool,
  ...
  handleInputChange: function handleInputChange() {
    ...
    var yearInteger = parseInt(year, 10) + (this.props.taiwanFormat ? 1911 : 0);
